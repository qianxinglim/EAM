            ...
            public void onSuccess() {
                getLeaveList(new OnCallBack() {
                    ...
                    public void onSuccess() {
                        ...
                        ViewAttendanceAdapter viewAttendanceAdapter = new ViewAttendanceAdapter(userId, userName, userProfilePic, list, datelist, leavelist,ViewAttendanceActivity.this);
